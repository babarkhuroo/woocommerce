...
<head>
	<style type="text/css">
		...
		p { line-height: <?php echo $constants['line_height']/2; ?>pt; margin: 0 0 <?php echo $constants['margin']/2; ?> 0; }
		<!-- (cardIconCSS()) -->
	</style>
</head>
...
<header>
	...
	<p>
		...
		<span class="card-icon <?php echo $card_icon_name; ?>-icon"></span> - <?php echo $card_last_digits; ?>
	</p>
</header>
